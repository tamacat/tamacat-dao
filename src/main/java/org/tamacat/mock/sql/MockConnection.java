...
public class MockConnection implements Connection {
    ...
    /**
     * @return the {@code MockPreparedStatement}s created via {@link #prepareStatement(String)},
     *         in creation order
     * @since 2.0
     */
    ...
    /**
     * @return the most recently created {@code MockPreparedStatement}, or {@code null}
    ...
    public MockPreparedStatement getLastPreparedStatement() {
        ...
        return preparedStatements.get(preparedStatements.size() - 1);
    }

    /**
     * Clears the recorded {@code MockPreparedStatement}s. This {@code MockConnection}
     * is shared across tests (via {@link MockDriver#getInstance()}), so tests that
     * count statements should call this in {@code @Before}.
     * @since 2.0
     */
